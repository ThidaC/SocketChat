...
public class ClientChat extends Applet {
	...
	final static String pol = "Monospaced";		/* Police de caract̬re de conversation */
	int tail = 11;					/* Taille des caract̬res de conversation */
	...
	public void init() {
		...
		cad.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				// la fermeture est effective apr̬s setVisible et dispose
